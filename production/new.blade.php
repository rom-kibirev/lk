...
<div id="dog_list">
    @foreach($docs as $doc)
                    ...
                    <div id="block_body">
                        ...
                        <div id="managers">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                @if (!empty ($doc->reserv_men_wt))
                                    <div class="man_cont"><a href="#"><img src="/images/images.png" width="25"/><span>
                                            Раб. тел.:</span><span
                            ...
                            @if (!empty ($doc->reserv_ip_men_fio))
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    @if (!empty ($doc->reserv_ip_men_wt))<div class="man_cont"><a href="#"><img
                                                    src="/images/images.png"
                                                    width="25"/><span> Раб. тел.:</span><span
                        ...
                        <table id="ict_res" border="0" cellspacing="0" cellpadding="10"
                            ...
                            @if (isset ($doc->reservs->reserv))
                                ...
                                @foreach($doc->reservs->reserv as $reserve)
                                    <tr>
                                        <td class="col-lg-8 col-md-8 col-sm-8" id="reserv_id">{{$reserve->reserv_id}}</td>
                                        <td align="center" id="reserv_end_date">{{$reserve->reserv_end_date}}</td>
                                    </tr>
                                @endforeach
                            @endif
                        </table>
                        ...
                        <div id="ict_app" class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <div><a target="_blank" href="/upload/pamytka.pdf"><img src="/images/save.png"
                                                                                        width="45"/></a></div>
                            </div>
        ...
        @if ($doc->type == 'flat_completed' or $doc->type == 'flat_under_construction')
            <?php
            preg_match_all('!\d+!', $doc->subject_dog, $matches);
            $building_info = $matches[0];
            if (stripos($doc->subject_dog, 'Север') === false) $building_info['link'] = 'http://yuntolovo-spb.ru/gallery/building-progress/'.$building_info[0].'-ya-ochered/';
            else $building_info['link'] = 'https://sevdol.ru/gallery/building-progress/'.$building_info[0].'-ochered/korpus-'.$building_info[1];
            ?>
            <div id="dog_cl" data-id="{{$doc->id}}">
                ...
                <div class="container" id="dog_block">
                    ...
                    <div id="block_body">
                        ...
                        <div>Договор № <span id="doc_id">{{$doc->num_dog}}</span> от <span
                                    id="date_dog">{{$doc->date_dog}}</span>г.
                        </div>

                        @if (!empty ($doc->readiness))
                        ...
                        <div id="sec_pan" class="@if (!empty ($doc->readiness)) col-lg-8 col-md-8 col-sm-8 @else
                                col-lg-12 col-md-12 col-sm-12 @endif right_block">

                            <table width="100%" border="0" cellspacing="10" cellpadding="0">
                                <tr>
                                    <td><span>Корпус сдается</span></td>
                                    <td id="plandate" align="right"><span>{{strval($doc->plandate)}}</span></td>
                                </tr>
                                <tr>
                                ...
                                @if (isset ($doc->ipot_bank) and !empty ($doc->ipot_bank))
                                    <tr>
                                        ...
                                        <td id="ipot_bank" align="right"><span>{{$doc->ipot_bank}}</span></td>
                                    </tr>
                                @endif
                            </table>
                ...
                <div class="container" id="dog_block">
                    ...
                    <div id="block_body">
                        ...
                        <div id="sec_pan" class="col-lg-12 col-md-12 col-sm-12 right_block">
                            ...
                            @if  (strlen($doc->ost_sum_doc) > 3)<div class="rb_pl"><span class="rb_left">Осталось погасить по
            договору</span> <span
                                        id="ost_sum_dog" class="money rb_right">{{$doc->ost_sum_dog}}</span></div>@endif
                        </div>
                    ...
                    <div id="block_body">
                        ...
                        <div id="sec_pan" class="col-lg-12 col-md-12 col-sm-12 right_block">
                            <div class="col-lg-4 col-md-4 col-sm-4"><p>ЕДИНОВРЕМЕННАЯ ОПЛАТА ИЛИ РАССРОЧКА. КВАРТИРА В СТРОЕЩЕМСЯ ДОМЕ</p>
                                <p><a target="_blank" href="/upload/pam_100_ras.pdf"><img
                                                src="/images/ds_save.png" width="45"/></a></p></div>
                            <div class="col-lg-4 col-md-4 col-sm-4"><p>ВОЕННАЯ ИПОТЕКА. КВАРТИРА В СТРОЯЩЕМСЯ ДОМЕ</p>
                                <p><a target="_blank" href="/upload/voen.pdf"><img src="/images/ds_save.png"
                                                                                   width="45"/></a></p></div>
                            <div class="col-lg-4 col-md-4 col-sm-4"><p>ИПОТЕКА. КВАРТИРА В <br />СТРОЯЩЕМСЯ
                                    ДОМЕ</p>
                                <p><a target="_blank" href="/upload/ipot.pdf"><img src="/images/ds_save.png"
                                                                                   width="45"/></a></p></div>
                        </div>
